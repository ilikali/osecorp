...
export default class Partners{
    constructor(options){
      ...
      parent.waveMaterial = new THREE.ShaderMaterial({
        fragmentShader: `
        ...
        vertexShader: `
          ...
          void main() {
            ...
            float noiseFreq = 3.5;
            float noiseAmp = 0.1;
            vec3 noisePos = vec3(pos.x * noiseFreq + iTime/4., pos.y, pos.z);
        ...
        `,
        uniforms: {
          sky: {type: "t", value: parent.textureLoader.load('/textures/sky.png')},
          iTime: { value: 0 },
